---
title: 系统设置
description: 查看与调整本地数据目录、深/浅主题，以及"关于"页的版本与开源归属信息。
category: 远程与设置
order: 18
lang: zh-CN
---

系统设置是 NomiFun 的"应用级"配置面：在这里查看本地数据存放在哪、切换深色 / 浅色主题，并在"关于"页确认当前版本与开源归属。它与伙伴、模型、渠道等业务配置相互独立——那些各有专门页面，本页只管应用本身。
...
4. **查看关于信息**。打开「关于」分组，确认当前版本与开源归属。

   ![关于（版本 / 归属）](/images/zh/设置/关于.png)
