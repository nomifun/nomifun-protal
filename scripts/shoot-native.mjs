...
await p.evaluate(()=>{const els=[...document.querySelectorAll('section')];const el=els.find(e=>e.textContent.includes('不是套壳'));el.scrollIntoView();});
await new Promise(r=>setTimeout(r,400));
await p.screenshot({path:'/tmp/shots/native2.png'});
console.log('ok');
await b.close();
